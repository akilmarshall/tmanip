/*
 * Singleton class that allows the user to manipulate the terminal cursor
 * position as well as the color of the text produced.
 */
#ifndef TMANIP_H
#define TMANIP_H
...
std::string fg(std::tuple<int, int, int> color, std::string s) {
    int r, g, b;
    std::tie(r, g, b) = color;
    auto rs = std::to_string(r);
    auto gs = std::to_string(g);
...
std::string bg(std::tuple<int, int, int> color, std::string s) {
    int r, g, b;
    std::tie(r, g, b) = color;
    auto rs = std::to_string(r);
    auto gs = std::to_string(g);
...
class Cursor {
   public:
    ...
    void bold() { std::cout << "\e[1m"; }
    void dim() { std::cout << "\e[2m"; }
    void italic() { std::cout << "\e[3m"; }
    void underline() { std::cout << "\e[4m"; }
    void blink() { std::cout << "\e[5m"; }
    void invert() { std::cout << "\e[7m"; }
    void unset_all() { std::cout << "\e[0m"; }
    void unset_bold() { std::cout << "\e[21m"; }
    void unset_dim() { std::cout << "\e[22m"; }
    void unset_underline() { std::cout << "\e[24m"; }
    void unset_blink() { std::cout << "\e[25m"; }
    void unset_inverse() { std::cout << "\e[27m"; }
    void clear_screen() { std::cout << "\e[2J"; }
    ...
    void fg(std::tuple<int, int, int> color) {
        int r, g, b;
        std::tie(r, g, b) = color;
        // Set the foreground color to rgb(r,g,b).
        auto rs = std::to_string(r);
    ...
    void bg(std::tuple<int, int, int> color) {
        int r, g, b;
        std::tie(r, g, b) = color;
        // Set the background color to rgb(r,g,b).
        auto rs = std::to_string(r);
